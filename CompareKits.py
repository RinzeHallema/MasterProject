...
SGM = ['D2S1338', 'D3S1358', 'FGA', 'D8S1179', 'TH01', 'vWA', 'D16S539', 'D18S51', 'D19S433', 'D21S11']
NGM = ['D1S1656', 'D2S441', 'D2S1338', 'D3S1358', 'FGA', 'SE33', 'D8S1179', 'D10S1248', 'TH01', 'vWA', 'D12S391', 'D16S539', 'D18S51', 'D21S11', 'D22S1045']
all_loci = [
...
# # Load data for first donor
llh_estimate, marg_likelihood_per_locus_genotype = dnax.run(Path("Mixtures/3_1B3.txt"), 3)
cleanmarg = clean_dict_from_marg0(marg_likelihood_per_locus_genotype)
# # First donor all loci
kit = all_loci
...
true_genotype = list((format_allele(a1), format_allele(a2)) for a1, a2 in zip(df['Allele1'], df['Allele2']))
...
make_histogram(log10_lrs, '3_1B3_first_sampling', log_true_LR)
# First donor NGM
kit = NGM
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
df = pd.read_csv(r'U:\RIHAL-admin\PycharmProjects\PythonProject\.venv\1A.csv', delimiter=';')
true_genotype = list((format_allele(a1), format_allele(a2))for locus, a1, a2 in zip(df['Marker'], df['Allele1'], df['Allele2'])if locus in kit)
true_genotype_with_Q = true_genotype_to_Q([true_genotype], cleanmarg, kit)
true_LR = compute_full_LRs_from_top_posteriors(cleanmarg, kit, true_genotype_with_Q)
log_true_LR = math.log10(true_LR[0])
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_first_sampling_NGM', log_true_LR)
# First donor SGM
kit = SGM
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_first_sampling_SGM', log_true_LR)

# Load data for second donor
cleanmarg = clean_dict_from_marg1(marg_likelihood_per_locus_genotype)
# Second donor all loci
kit = all_loci
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_second_sampling', log_true_LR)
# Second donor NGM
kit = NGM
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_second_sampling_NGM', log_true_LR)
# Second donor SGM
kit = SGM
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_second_sampling_SGM', log_true_LR)

# Load data for third donor
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_third_sampling', log_true_LR)
# Third donor NGM
kit = NGM
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_third_sampling_NGM', log_true_LR)
# Third donor SGM
kit = SGM
sampled_genotypes, posterior_dict = sample_full_genotypes(cleanmarg, kit, 100000)
full_LRs = compute_full_LRs_from_top_posteriors(cleanmarg, kit, sampled_genotypes)
...
lr_values = list(full_LRs)
log10_lrs = np.log10(lr_values)
make_histogram(log10_lrs, '3_1B3_third_sampling_SGM', log_true_LR)
